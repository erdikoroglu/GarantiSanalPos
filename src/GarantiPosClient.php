...
class GarantiPosClient
{
     ...
     */
    private function generateSecurityHash(string $orderId, string $terminalId, string $amount,string $successUrl, string $type, string $storeKey,?string $installment): string
    {
